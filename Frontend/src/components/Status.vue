    ...
    <div class="status-container" >
        ...
        <b-row no-gutters>
            <b-button variant="danger" 
                v-show="reportCovid"
                @click="onReportPositive()">
            Proceed to Report
            </b-button>
            <b-button variant="success" 
                v-show="!reportCovid && !reportRecovery"
                @click="onReportNegative()">
            Proceed to Report
            </b-button>
            <b-button variant="success" 
                v-show="reportRecovery"
                @click="onReportRecovery()">
            Proceed to Report
            </b-button>
        </b-row>
    </div>
...
export default {
    ...
    methods:
    {
        ...
        onReportPositive()
        {
            this._reportStatusChange("corona"); 
            this.$store.dispatch('storeUserStatus', 'corona')
            this._onReportComplete()
        },
        onReportRecovery()
        {
            this._reportStatusChange("recovered"); 
